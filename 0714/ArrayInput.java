public class ArrayInput {
    ...
    public static void main(String[] args) {
        ...
        printSummary(studentAverages, subjectAverages, classAverage, maxGrade, minGrade);
    }
    ...
    public static void printSummary(double[] studentAverages, double[] subjectAverages, double classAverage, int maxGrade, int minGrade) {
        System.out.println("\n=== 成績統計摘要 ===");
        ...
        System.out.println("[ 全班全體統計 ]");
        System.out.printf("  全班總平均分數: %.2f 分\n", classAverage);
        System.out.println("  全班最高分數: " + maxGrade + " 分");
        System.out.println("  全班最低分數: " + minGrade + " 分");
    }
}